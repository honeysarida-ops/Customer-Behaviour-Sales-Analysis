...
**Exploratory analysis of transaction data to uncover revenue drivers, customer patterns, and delivery/satisfaction dynamics.**
...
Explore a transactions dataset to answer practical business
...
| File | Description |
|---|---|
| `customer-behavior-sales-analysis.ipynb` | Full notebook — EDA, revenue analysis, delivery/satisfaction analysis |
| `customer-behavior-sales-analysis.pdf` | Read-only, formatted export of the notebook |
